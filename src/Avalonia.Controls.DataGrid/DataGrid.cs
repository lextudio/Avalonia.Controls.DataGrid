...
namespace Avalonia.Controls
{
    ...
    partial class DataGrid : TemplatedControl
    {
        ...
        /// <summary>
        /// WPF compatibility: applies a Style targeting DataGridCell to this grid.
        /// </summary>
        ...
        {
            get => GetValue(CellStyleProperty);
            set => SetValue(CellStyleProperty, value);
        }

        // WPF compatibility: stubs for add/delete rows flags (not implemented).
    ...
    internal IDataGridCollectionView CollectionView =>
        ...
        /// <summary>
        /// WPF compatibility stub: fired after auto-generated columns are created.
        /// </summary>
